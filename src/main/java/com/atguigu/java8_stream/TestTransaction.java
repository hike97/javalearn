...
public class TestTransaction {
	...
	public void test5(){
		...
		System.out.println( "是否有在米兰的？" + (milan == true ? "是" : "否") );
	}
	...
	@Test
	public void test6(){
		Optional<Integer> cambridge = transactions.stream().filter( e -> e.getTrader().getCity().equals( "Cambridge" ) )
	...
	@Test
	public void test7(){
		Optional<Integer> max = transactions.stream().map( transaction -> transaction.getValue() )
				.max( Integer::compare );
